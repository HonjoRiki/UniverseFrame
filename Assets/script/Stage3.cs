...
public class Stage3 : MonoBehaviour
{
    ...
    public GameObject EnemyGroup1, EnemyGroup2, EnemyGroup3, Boss;
    ...
    void Wave2()
    {
        ...
        Instantiate(EnemyGroup3, point3.transform.position, Quaternion.identity);
    }
    ...
    void Wave3()
    {
        info2.enabled = false;
        info3.enabled = true;
        Instantiate(Boss, point1.transform.position, Quaternion.identity);
    }
